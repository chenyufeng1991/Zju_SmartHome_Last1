...
- (void)viewDidLoad
{
  [super viewDidLoad];
    self.i = 0;
//    self.colorPreview.backgroundColor=[UIColor orangeColor];
//    self.rValue.text=@"214";
//    self.gValue.text=@"177";
//    self.bValue.text=@"2";
...
//    self.colorPreview.backgroundColor=[UIColor colorWithRed:255 green:253 blue:187 alpha:1];
//    NSString *r = [NSString stringWithFormat:@"%@",[[NSString alloc] initWithFormat:@"%1x",254]];
//    NSString *g = [NSString stringWithFormat:@"%@",[[NSString alloc] initWithFormat:@"%1x",242]];
//    
//    NSString *b = [NSString stringWithFormat:@"%@",[[NSString alloc] initWithFormat:@"%1x",184]];
...
//                self.colorPreview.backgroundColor=[UIColor colorWithRed:255 green:253 blue:187 alpha:1];
                self.colorPreview.backgroundColor=[UIColor greenColor];
            ...
            case 1:
                ...
                [self blueSlider];
                self.colorPreview.backgroundColor=[UIColor colorWithRed:168 green:43 blue:181 alpha:1];
                [self dinnerFirst];
            ...
            case 2:
                ...
                [self yellowSlider];
                self.colorPreview.backgroundColor=[UIColor colorWithRed:255 green:235 blue:206 alpha:1];
                [self readFirst];
            ...
            case 3:
                ...
                [self blueSlider];
                self.colorPreview.backgroundColor=[UIColor colorWithRed:38 green:95 blue:145 alpha:1];
                [self sleepFirst];
                break;
            case 4:
...
//                self.colorPreview.backgroundColor = [UIColor colorWithRed:0.588 green:0.882 blue:0.380 alpha:1.000];
                [self blueSlider];
                self.colorPreview.backgroundColor=[UIColor colorWithRed:255 green:238 blue:0 alpha:1];
                [self customFirst];
                break;
            default:
                break;
        ...
        switch (_i) {
            case 0:
                ...
                self.modeTitle.text = @"会客模式";
                [self yellowSlider];
//                self.colorPreview.backgroundColor = [UIColor colorWithRed:1.000 green:1.000 blue:0.682 alpha:1.000];
                self.leftFront.enabled = NO;
                break;
            case 1:
                ...
                self.modeTitle.text = @"烛光晚宴";
                [self blueSlider];
//                self.colorPreview.backgroundColor = [UIColor colorWithRed:0.600 green:0.000 blue:0.663 alpha:1.000];
                break;
            case 2:
                _imgView.image = [UIImage imageNamed:@"YWCircle_6"];
                self.modeImage.image = [UIImage imageNamed:@"阅读"];
...
//                self.colorPreview.backgroundColor = [UIColor colorWithRed:1.000 green:1.000 blue:0.682 alpha:1.000];
            ...
            case 3:
                ...
                self.modeTitle.text = @"睡眠模式";
                [self blueSlider];
//                self.colorPreview.backgroundColor = [UIColor colorWithRed:0.110 green:0.298 blue:0.502 alpha:1.000];
                break;
            case 4:
...
//                self.colorPreview.backgroundColor = [UIColor colorWithRed:0.588 green:0.882 blue:0.380 alpha:1.000];
    ...
    self.colorPreview.backgroundColor = [self getPixelColorAtLocation: CGPointMake(self.panelView.frame.origin.x + self.viewColorPickerPositionIndicator.center.x, self.panelView.frame.origin.y + self.viewColorPickerPositionIndicator.center.y)];
}
